...
import Detail1 from '../Pages/Detail1.js';
import Detail2 from '../Pages/Detail2.js';

const MainIcon = require('../../src/resources/gailan.png');
...
const MyTab = TabNavigator({
    Test1: {
        ...
        navigationOptions: ({navigation, screenProps}) => ({
            ...
            tabBarIcon: (({tintColor, focused}) => {
                return (
                    <Image
                        source={!focused ? MainIcon : MainIcon}
                        style={[
                            {height: 35, width: 35},
                            // {tintColor: tintColor}  //tintColor这个属性可以选择不用
                        ]}
                    />
                )
            }), // 设置标签栏的图标。需要单独设置。
            tabBarLabel: '概览', // 设置标签栏的title。推荐这个方式。
        })
    },
    Test2: {
        screen: Test2,
    ...
    Test3: {
        screen: Test3,
        navigationOptions: () => TabOptions('我的', PersonIcon, PersonIcon, '我的'),
    },
}, {
